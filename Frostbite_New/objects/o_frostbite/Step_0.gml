if state == "Move" or state == "Jump" or state == "Up B" or state == "U Special" or state == "Free Fall" or state == "Zero-Degree Form" or state == "Shield"
{
	pause_button();
}
switch (state)
{
	...
	if global.pause == 1
		...
		launch = 0;
		up_b_count = 0;
		if zero_degree_meter == 1
		{
			state = "Zero-Degree Form";
		}
	if input.run
	{
...
#endregion
#region slashes
	if input.slash and not input.left and not input.right and not input.down and not input.up
		{
			state = "N slash";
		}
		
	if input.slash and input.left and not input.right and not input.up and not input.down
		{
			state = "F slash";
		}
		
	if input.slash and input.right and not input.left and not input.up and not input.down
		{
			state = "F slash";
		}
		
	if input.slash and input.up and not input.down 
		{
			state = "U slash";
		}
		
	if input.slash and input.down and not input.up
		{
			state = "D slash";
		}
#endregion
#region kicks
if input.kick and not input.left and not input.right and not input.down and not input.up
		{
			state = "N kick";
		}
		
	if input.kick and input.left and not input.right and not input.up and not input.down
		{
			state = "F kick";
		}
		
	if input.kick and input.right and not input.left and not input.up and not input.down
		{
			state = "F kick";
		}
		
	if input.kick and input.up and not input.down 
		{
			state = "U kick";
		}
		
	if input.kick and input.down and not input.up
		{
			state = "D kick";
		}
#endregion
#region punches
if input.punch and not input.left and not input.right and not input.down and not input.up
		{
			state = "N punch";
		}
		
	if input.punch and input.left and not input.right and not input.up and not input.down
		{
			state = "F punch";
		}
		
	if input.punch and input.right and not input.left and not input.up and not input.down
		{
			state = "F punch";
		}
		
	if input.punch and input.up and not input.down 
		{
			state = "U punch";
		}
		
	if input.punch and input.down and not input.up
		{
			state = "D punch";
		}
#endregion
#region heavy
if input.heavy and not input.left and not input.right and not input.down and not input.up
		{
			state = "N heavy";
		}
		
	if input.heavy and input.left and not input.right and not input.up and not input.down
		{
			state = "F heavy";
		}
		
	if input.heavy and input.right and not input.left and not input.up and not input.down
		{
			state = "F heavy";
		}
		
	if input.heavy and input.up and not input.down 
		{
			state = "U heavy";
		}
		
	if input.heavy and input.down and not input.up
		{
			state = "D heavy";
		}
#endregion
#region abilities
	if input.ability and input.up and not input.down
		{
			state = "U Special";
		}
		
	if input.ability and input.down and not input.up
		{
			state = "D Special";
		}
		
	if input.ability and input.left and not input.down and not input.right and not input.up
		{
			state = "F Special";
		}
		
	if input.ability and input.right and not input.down and not input.up and not input.left
		{
			state = "F Special";
		}
		
	if input.ability and not input.up and not input.down and not input.right and not input.left
		{
			state = "N Special";
		}
#endregion
	...
	#endregion	
		break;
	#region Ground slashs	
	case "N slash":
	#region Jab One
	set_state_sprite(s_n_slash, 0.25, 0);
	...
	case "F slash":
	#region F Tilt
	set_state_sprite(s_f_slash, 1, 0);
	
		if animation_hit_frame(3)
		{
			create_hitbox(x, y, self, s_f_slash_damage, 10, 2, 1, 30, image_xscale);
		}
	...
	case "D slash":
	#region D Tilt
	set_state_sprite(s_d_slash, 0.25, 0);
	...
	case "U slash":
	#region U Tilt
	set_state_sprite(s_u_slash, 0.25, 0);
	...
	launch_coordinates = 0;
		...
		if global.pause == 1
			...
			#endregion
	#region slash inputs
	if input.slash and input.right and image_xscale == 1 and not input.left and not input.up and not input.down
		{
			state = "F Air slash";	
		}
	...
	if input.slash and input.left and image_xscale == -1 and not input.right and not input.up and not input.down
		{
			state = "F Air slash";	
		}
	...
	if input.slash and move = 0 and not input.up and not input.down
		{
			state = "N Air slash";
		}
		#endregion
	#region kicks
	if input.kick and input.right and image_xscale == 1 and not input.left and not input.up and not input.down
		{
			state = "F Air kick";	
		}
	...
	if input.kick and input.left and image_xscale == -1 and not input.right and not input.up and not input.down
		{
			state = "F Air kick";	
		}
	...
	if input.kick and move = 0 and not input.up and not input.down
		{
			state = "N Air kick";
		}
		#endregion
	#endregion
	#region punches
	if input.punch and input.right and image_xscale == 1 and not input.left and not input.up and not input.down
		{
			state = "F Air punch";	
		}
	...
	if input.punch and input.left and image_xscale == -1 and not input.right and not input.up and not input.down
		{
			state = "F Air punch";	
		}
	...
	if input.punch and move = 0 and not input.up and not input.down
		{
			state = "N Air punch";
		}
	#endregion
	#region heavys
	if input.heavy and input.right and image_xscale == 1 and not input.left and not input.up and not input.down
		{
			state = "F Air heavy";	
		}
	...
	if input.heavy and input.left and image_xscale == -1 and not input.right and not input.up and not input.down
		{
			state = "F Air heavy";	
		}
	...
	if input.heavy and move = 0 and not input.up and not input.down
		{
			state = "N Air heavy";
		}
	#endregion
	...
	if input.ability and input.up and not input.down && up_b_count == 0
		{
			state = "U Special";
		}
	#endregion
...
#region Air slashs
	case "F Air slash":
	#region Fair
	set_state_sprite(s_f_air_slash, 1, 0);
	air_movement();
	
	if animation_hit_frame(1)
		{
			create_hitbox(x, y, self, s_f_air_slash_damage, 5, 2, 4, 20, image_xscale);
		}
	...
	case "B Air slash":
	#region Bair
	set_state_sprite(s_b_air_slash, 0.5, 0);
		air_movement();
	
	if animation_hit_frame(1)
		{
			create_hitbox(x, y, self, s_n_air_slash_damage, 5, 2, 4, 4, image_xscale);
		}
	...
	case "N Air slash":
	#region Nair
	set_state_sprite(s_n_air_slash, 0.5, 0);
		air_movement();
	...
	case "D Air slash":
	#region Dair
	set_state_sprite(s_d_air_slash, 0.8, 0);
		air_movement();
	
	if animation_hit_frame(1)
		{
			create_hitbox(x, y, self, s_d_air_slash_damage, 5, 2, 4, 4, image_xscale);
		}
	...
	case "U Air slash":
	#region Uair
	set_state_sprite(s_u_air_slash, 0.5, 0);
		air_movement();
	
	if animation_hit_frame(1)
		{
			create_hitbox(x, y, self, s_u_air_slash_damage, 5, 2, 4, 4, image_xscale);
		}
...
#region Air kicks
	case "F Air kick":
	#region F kick
	set_state_sprite(s_f_air_kick, 1, 0);
	air_movement();
	
	if animation_hit_frame(1)
		{
			create_hitbox(x, y, self, s_f_air_kick_damage, 5, 2, 4, 20, image_xscale);
		}
	...
	case "B Air kick":
	#region Bair
	set_state_sprite(s_b_air_kick, 0.5, 0);
		air_movement();
	
	if animation_hit_frame(1)
		{
			create_hitbox(x, y, self, s_n_air_kick_damage, 5, 2, 4, 4, image_xscale);
		}
	...
	case "N Air kick":
	#region Nair
	set_state_sprite(s_n_air_kick, 0.5, 0);
		air_movement();
	...
	case "D Air kick":
	#region Dair
	set_state_sprite(s_d_air_kick, 0.8, 0);
		air_movement();
	
	if animation_hit_frame(1)
		{
			create_hitbox(x, y, self, s_d_air_kick_damage, 5, 2, 4, 4, image_xscale);
		}
	...
	case "U Air kick":
	#region Uair
	set_state_sprite(s_u_air_kick, 0.5, 0);
		air_movement();
	
	if animation_hit_frame(1)
		{
			create_hitbox(x, y, self, s_u_air_kick_damage, 5, 2, 4, 4, image_xscale);
		}
...
#region Specials
	...
	case "Zero-Degree Form":
	#region Zero-Degree Form
	set_state_sprite(s_move_zero_degree, 1, 0);
	zero_degree_movement();
	pause_button();
	if alarm[1] = 0
	{
		landing_air_attack();
