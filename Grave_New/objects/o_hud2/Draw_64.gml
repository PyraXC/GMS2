...
//{
//	draw_hp = lerp(draw_hp, obj_skeleton2.hp, 0.2);
//	draw_max_hp = obj_skeleton2.max_hp;
//} else {
...
//if not instance_exists(obj_skeleton2) exit;
//var text = "Kills: " + string(obj_skeleton2.kills);
...
//var text = "Level: " + string(obj_skeleton2.level);
